...
const ContactForm = (props) => {
    ...
    return React.createElement("form", { action: "https://formsubmit.co/elegantstone.ba@gmail.com", method: "POST", className: "lg:w-2/3 grid grid-cols-1 overflow-hidden lg:!grid-cols-2 gap-4 items-start justify-start p-12 bg-opacity-20 bg-gray-200 dark:bg-gray-800" },
